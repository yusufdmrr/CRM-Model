...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(t)
      : ((e = e || self).FilePondPluginImageResize = t())
})(this, function () {
  'use strict'
  var e = function (e) {
    var t = e.addFilter,
      ...
      t('DID_LOAD_ITEM', function (e, t) {
        ...
        return new Promise(function (t, n) {
          ...
          if (
            ...
            return t(e)
          var u = i('GET_IMAGE_RESIZE_MODE'),
            o = i('GET_IMAGE_RESIZE_TARGET_WIDTH'),
            a = i('GET_IMAGE_RESIZE_TARGET_HEIGHT'),
            l = i('GET_IMAGE_RESIZE_UPSCALE')
          if (null === o && null === a) return t(e)
          var d,
            f,
            E,
            s = null === o ? a : o,
          ...
          ;(d = I),
            (f = function (i) {
              if ((URL.revokeObjectURL(I), !i)) return t(e)
              var n = i.width,
                r = i.height,
                o = (e.getMetadata('exif') || {}).orientation || -1
              if (o >= 5 && o <= 8) {
                var a = [r, n]
                ;(n = a[0]), (r = a[1])
              }
              if (n === s && r === c) return t(e)
              if (!l)
                if ('cover' === u) {
                  if (n <= s || r <= c) return t(e)
                } else if (n <= s && r <= s) return t(e)
            ...
            ((E = new Image()).onload = function () {
              var e = E.naturalWidth,
                t = E.naturalHeight
              ;(E = null), f({ width: e, height: t })
            }),
            (E.onerror = function () {
              return f(null)
            }),
