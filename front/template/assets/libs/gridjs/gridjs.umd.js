!(function (t, e) {
  ...
  function w(t, e, n) {
    ...
    if (
      (arguments.length > 2 &&
        (s.children = arguments.length > 3 ? l.call(arguments, 2) : n),
      'function' == typeof t && null != t.defaultProps)
    )
      for (o in t.defaultProps) void 0 === s[o] && (s[o] = t.defaultProps[o])
    return P(t, s, r, i, null)
  }
  ...
  function N(t) {
    ;((!t.__d && (t.__d = !0) && f.push(t) && !E.__r++) ||
      d !== c.debounceRendering) &&
      ((d = c.debounceRendering) || setTimeout)(E)
  }
  function E() {
    for (var t; (E.__r = f.length); )
      (t = f.sort(function (t, e) {
      ...
      if (
        ...
        (f = n.__k[c] =
          null == (f = e[c]) || 'boolean' == typeof f
            ...
            : 'string' == typeof f ||
                'number' == typeof f ||
                'bigint' == typeof f
              ? P(null, f, null, null, f)
              : Array.isArray(f)
                ? P(S, { children: f }, null, null, null)
                : f.__b > 0
                  ? P(f.type, f.props, f.key, null, f.__v)
                  : f)
      ) {
        if (
          ((f.__ = n),
        ...
        U(t, f, (h = h || m), i, o, s, a, u, l),
          ...
          null != d
            ...
            : u && h.__e == u && u.parentNode != t && (u = C(h))
      }
    for (n.__e = _, c = b; c--; )
      null != y[c] &&
        ('function' == typeof n.type &&
          ...
          (n.__d = C(r, c + 1)),
        j(y[c], y[c]))
    if (v) for (c = 0; c < v.length; c++) O(v[c], v[++c], v[++c])
  }
  function T(t, e, n) {
    for (var r, i = t.__k, o = 0; i && o < i.length; o++)
      (r = i[o]) &&
        ((r.__ = t),
        (e =
          'function' == typeof r.type ? T(r, e, n) : D(n, r, r, i, r.__e, e)))
    return e
  }
  ...
  function R(t, e, n) {
    '-' === e[0]
      ? t.setProperty(e, n)
      : (t[e] =
          null == n ? '' : 'number' != typeof n || v.test(e) ? n : n + 'px')
  }
  function A(t, e, n, r, i) {
    ...
    t: if ('style' === e)
      ...
      (o = e !== (e = e.replace(/Capture$/, ''))),
        ...
        (t.l[e + o] = n),
        n
          ? r || t.addEventListener(e, o ? I : L, o)
          : t.removeEventListener(e, o ? I : L, o)
      ...
      t: if ('function' == typeof x) {
        if (
          ...
          null != x.getDerivedStateFromProps &&
            ...
            y(p.__s, x.getDerivedStateFromProps(g, p.__s))),
          (f = p.props),
          (d = p.state),
          h)
        )
  ...
  function M(t, e, n, r, i, o, s, a) {
    ...
    if (null === d) h === f || (a && t.data === f) || (t.data = f)
      ...
      if (
        ((o = o && l.call(t.childNodes)),
        (c = (h = n.props || m).dangerouslySetInnerHTML),
      ...
      if (
        ((function (t, e, n, r, i) {
          var o
          for (o in n)
            'children' === o || 'key' === o || o in e || A(t, o, null, n[o], r)
          for (o in e)
        ...
        for (_ = o.length; _--; ) null != o[_] && b(o[_])
      a ||
        ('value' in f &&
          void 0 !== (_ = f.value) &&
          (_ !== t.value ||
            ('progress' === d && !_) ||
            ('option' === d && _ !== h.value)) &&
          A(t, 'value', _, h.value, !1),
        'checked' in f &&
          void 0 !== (_ = f.checked) &&
          _ !== t.checked &&
          A(t, 'checked', _, h.checked, !1))
    }
    return t
  }
  function O(t, e, n) {
  ...
  function j(t, e, n) {
    ...
    if ((r = t.__k))
      for (i = 0; i < r.length; i++)
        r[i] && j(r[i], e, 'function' != typeof t.type)
    n || null == t.__e || b(t.__e), (t.__e = t.__d = void 0)
  }
  function W(t, e, n) {
  ...
  function B(t, e, n) {
    ...
    c.__ && c.__(t, e),
      ...
      U(
        e,
        (t = ((!r && n) || e).__k = w(S, null, [t])),
        i || m,
        m,
        void 0 !== e.ownerSVGElement,
        !r && n ? [n] : i ? null : e.firstChild ? l.call(e.childNodes) : null,
        o,
  ...
  ;(l = g.slice),
    ...
    (k.prototype.setState = function (t, e) {
      ...
      ;(n =
        ...
        t && y(n, t),
        null != t && this.__v && (e && this.__h.push(e), N(this))
    }),
  ...
  var q = /*#__PURE__*/ (function () {
    ...
    V = {
      ...
      loading: 'Yükleniyor...',
      noRecordsFound: 'Eşleşen sonuç bulunamadı.',
    ...
    $ = /*#__PURE__*/ (function (t) {
      ...
      return (
        ...
        (e.prototype.render = function () {
          return w(this.props.parentElement, {
  ...
  function K(t, e) {
    return w($, { content: t, parentElement: e })
  }
    ...
    Q = /*#__PURE__*/ (function (t) {
      function e(e) {
        ...
        return (
          ...
          (n._length = void 0),
          (n.rows = e instanceof Array ? e : e instanceof J ? [e] : []),
          n
        )
      }
      return (
          ...
          if (this.props.pluginId) {
            ...
            return e
              ? w(
                  S,
                  {},
                  w(e.component, r({ plugin: e }, e.props, this.props.props)),
                )
              : null
          }
          return void 0 !== this.props.position
            ? w(
                ...
                this.config.plugin.list(this.props.position).map(function (e) {
                  return w(
                    e.component,
                    r({ plugin: e }, e.props, t.props.props),
                  )
                }),
              )
            : null
    ...
    _t = /*#__PURE__*/ (function (t) {
      function e(e, n) {
        ...
        ;((r = t.call(this, e, n) || this).searchProcessor = void 0),
          ...
          (r.actions = new lt(r.config.dispatcher)),
          (r.store = new at(r.config.dispatcher))
        var i,
          o = e.keyword
        return (
          e.enabled &&
            (o && r.actions.search(o),
            (r.storeUpdatedFn = r.storeUpdated.bind(s(r))),
      ...
      return (
        ...
        (n.render = function () {
          ...
          return (
            this.searchProcessor instanceof ct &&
              ((t = r),
          ...
          return w(
            ...
            this.props.summary &&
              ...
              w(
                ...
                ' ',
                w('b', null, this._('' + this.state.total)),
                ' ',
    ...
    return (
      (n.widths = function () {
        ;(this.tableElement.className =
          this.tableClassName + ' ' + rt('shadowTable')),
        ...
        var t = Array.from(
          ...
          return (
            ...
            r(
              (((n = {})[e.getAttribute('data-column-id')] = {
  ...
  var St = /*#__PURE__*/ (function (e) {
      function o() {
        var t
        return (
          ((t = e.call(this) || this)._columns = void 0), (t._columns = []), t
        )
      }
      i(o, e)
      var s = o.prototype
      return (
        (s.adjustWidth = function (t) {
          var e = t.container,
            n = t.tableRef,
            r = t.tempRef,
            i = t.tempRef || !0
          ...
          var s = e.clientWidth,
            ...
            l = {}
          if (n.current && i) {
            var c = w(wt, { tableRef: n })
            ;(c.ref = a), B(c, r.current), (l = a.current.widths())
          }
          for (
            var p,
              h = u(
                o.tabularFormat(this.columns).reduce(function (t, e) {
                  return t.concat(e)
                }, []),
              );
            !(p = h()).done;
            ...
            ;(f.columns && f.columns.length > 0) ||
              (!f.width && i
                ? f.id in l &&
                  ((f.width = bt(l[f.id].width)),
                  (f.minWidth = bt(l[f.id].minWidth)))
                : (f.width = bt(yt(f.width, s))))
          }
          return n.current && i && B(null, r.current), this
        }),
        ...
        (o.fromColumns = function (t) {
          for (var e, n = new o(), r = u(t); !(e = r()).done; ) {
            var i = e.value
            if ('string' == typeof i || h(i)) n.columns.push({ name: i })
        ...
        (o.fromHTMLTable = function (t) {
          for (
            var e,
              n = new o(),
              r = u(t.querySelector('thead').querySelectorAll('th'));
            !(e = r()).done;
    ...
    Et = /*#__PURE__*/ (function () {
      ...
      return (
        (t.createFromUserConfig = function (t) {
          var e = null
          return (
            t.data && (e = new xt(t.data)),
            t.from &&
              ((e = new xt(this.tableElementToArray(t.from))),
        ...
        (t.tableElementToArray = function (t) {
          for (
            var e,
              n,
              r = [],
              i = u(t.querySelector('tbody').querySelectorAll('tr'));
            !(e = i()).done;

          ) {
            for (
              var o, s = [], a = u(e.value.querySelectorAll('td'));
              !(o = a()).done;
  ...
  function Tt(t, e, n) {
    if (!t.s) {
      ...
      if (n && n.then)
        return void n.then(Tt.bind(null, t, e), Tt.bind(null, t, 2))
      ;(t.s = e), (t.v = n)
      var r = t.o
      r && r(t)
    }
                ...
                try {
                  var s = (function (t, e, n) {
                    ...
                    var n = e.findProcessorIndexByID(t.id),
                      i = (function () {
                        if (n >= r)
                          return Promise.resolve(t.process(o)).then(
                            function (n) {
        ...
        n(e, [
          {
            ...
            get: function () {
              for (
                var t, e = [], n = u(this.getSortedProcessorTypes());
                !(t = n()).done;
        ...
        (t.createFromConfig = function (t) {
          ...
          return (
            t.storage instanceof Nt &&
              e.register(new Ht({ serverStorageOptions: t.server })),
            e.register(new It({ storage: t.storage })),
            e.register(new Mt({ header: t.header })),
            e.register(new Ut()),
            e
          )
        }),
    ...
    jt = /*#__PURE__*/ (function () {
      function e(t) {
        ;(this._userConfig = void 0),
          Object.assign(this, r({}, e.defaultConfig(), t)),
          (this._userConfig = {})
      }
      var n = e.prototype
      return (
        ...
        (n.update = function (t) {
          return t
            ? ((this._userConfig = r({}, this._userConfig, t)),
        ...
        (e.fromUserConfig = function (n) {
          ...
          return (
            ...
            'boolean' == typeof n.sort &&
              n.sort &&
              i.assign({ sort: { multiColumn: !0 } }),
            i.assign({ header: St.fromUserConfig(i) }),
            i.assign({ storage: Et.createFromUserConfig(n) }),
            i.assign({ pipeline: Ot.createFromConfig(i) }),
            i.assign({ translator: new G(n.language) }),
            i.plugin.add({
              id: 'search',
  ...
  var Wt,
          ...
          return this.props.children
            ...
            : w(
                ...
                this.props.row.cells.map(function (e, n) {
                  ...
                  return r && r.hidden
                    ? null
                    : w(Vt, { key: e.id, cell: e, row: t.props.row, column: r })
                }),
              )
        }),
        (n.render = function () {
          ...
          return w(
            ...
            this.props.data &&
              this.props.data.rows.map(function (e) {
                return w(Gt, { key: e.id, row: e, header: t.props.header })
              }),
          ...
          for (var n, r = 0, i = u(this.props.columns); !(n = i()).done; ) {
            ...
            r |=
              'function' == typeof o.compare
                ? o.compare(s, a) * o.direction
                : this.compare(s, a) * o.direction
          }
          return r
        }),
        (r._process = function (t) {
    ...
    Qt = /*#__PURE__*/ (function (t) {
      function e(e, n) {
        ...
        return (
          ...
          (r.actions = new Zt(r.config.dispatcher)),
          (r.store = new Yt(r.config.dispatcher)),
          e.enabled &&
            ((r.sortProcessor = r.getOrCreateSortProcessor()),
            (r.updateStateFn = r.updateState.bind(s(r))),
              ...
              : ((this.updateSortProcessorFn =
                ...
                (e =
                  t === Y.ServerSort
                    ...
                    : new Kt({ columns: this.store.state })),
        ...
        (n.render = function () {
          ...
          return (
            ...
            w(
              ...
              r(
                {
                  ...
                  className: it(
                    rt('th'),
                    this.isSortable() ? rt('th', 'sort') : null,
                    this.props.column.fixedHeader ? rt('th', 'fixed') : null,
              ...
              w('div', { className: rt('th', 'content') }, this.content()),
              this.isSortable() &&
                w(
                  Qt,
                  r(
              ...
              this.isResizable() &&
                this.props.index <
                  this.config.header.visibleColumns.length - 1 &&
                w(te, { column: this.props.column, thRef: this.thRef }),
            )
          )
        }),
        e
    ...
    ie = /*#__PURE__*/ (function (e) {
      function n(t, n) {
        var r
        return (
          ((r = e.call(this, t, n) || this).headerRef = { current: null }),
          (r.state = { isActive: !0 }),
          r
        )
      }
        ...
        (o.render = function () {
          return this.state.isActive
            ? w(
                ...
                w(dt, { position: t.PluginPosition.Header }),
              )
            : null
        }),
        n
    ...
    oe = /*#__PURE__*/ (function (e) {
      function n(t, n) {
        var r
        return (
          ((r = e.call(this, t, n) || this).footerRef = { current: null }),
          (r.state = { isActive: !0 }),
          r
        )
      }
        ...
        (o.render = function () {
          return this.state.isActive
            ? w(
                ...
                w(dt, { position: t.PluginPosition.Footer }),
              )
            : null
        }),
        n
    ...
    se = /*#__PURE__*/ (function (t) {
      function e(e, n) {
        ...
        return (
          ...
          (r.state = { status: At.Loading, header: e.header, data: null }),
          r
        )
      }
      i(e, t)
      ...
      return (
        (n.processPipeline = function () {
          try {
            ...
            var e = (function (e, n) {
              ...
              pt.error(e), t.setState({ status: At.Error, data: null })
            })
        ...
        (n.componentDidUpdate = function (t, e) {
          e.status != At.Rendered &&
            this.state.status == At.Loaded &&
            (this.setState({ status: At.Rendered }),
            ...
            w(
              'div',
              {
                ...
                className: it(
                  'gridjs',
                  rt('container'),
                  this.state.status === At.Loading ? rt('loading') : null,
              ...
              this.state.status === At.Loading &&
                w('div', { className: rt('loading-bar') }),
              w(ie, null),
              w(
                'div',
                {
    ...
    ae = /*#__PURE__*/ (function (t) {
      function e(e) {
        ...
        return (
          ...
          (n.plugin = void 0),
          (n.config = new jt({ instance: s(n), eventEmitter: s(n) }).update(e)),
      ...
      return (
        ...
        (n.forceRender = function () {
          return (
            ...
            B(null, this.config.container),
            B(this.createElement(), this.config.container),
            this
          )
        }),
        (n.render = function (t) {
          return (
            ...
            t.childNodes.length > 0
              ? (pt.error(
                ...
                this)
              : ((this.config.container = t), B(this.createElement(), t), this)
          )
        }),
        e
      )
    ...
    _e = c.unmount
  function me(t, e) {
    c.__h && c.__h(Bt, t, ue || e), (ue = 0)
    var n = Bt.__H || (Bt.__H = { __: [], __h: [] })
    return t >= n.__.length && n.__.push({ __V: ce }), n.__[t]
  }
  function ge() {
    for (var t; (t = le.shift()); )
      if (t.__P && t.__H)
        try {
          t.__H.__h.forEach(ye), t.__H.__h.forEach(be), (t.__H.__h = [])
        } catch (e) {
    ...
    (c.__r = function (t) {
      ...
      e &&
        (zt === Bt
          ...
          : (e.__h.forEach(ye), e.__h.forEach(be), (e.__h = []))),
        (zt = Bt)
    }),
    (c.diffed = function (t) {
      fe && fe(t)
      ...
      e &&
        e.__H &&
        (e.__H.__h.length &&
          ((1 !== le.push(e) && qt === c.requestAnimationFrame) ||
            (
              (qt = c.requestAnimationFrame) ||
              function (t) {
                var e,
                  n = function () {
                    clearTimeout(r),
                      ve && cancelAnimationFrame(e),
                      setTimeout(t)
                  },
                  r = setTimeout(n, 100)
  ...
  ;(t.BaseActions = ut),
    ...
    (t.useEffect = function (t, e) {
      var n = me(Wt++, 3)
      !c.__s && we(n.__H, e) && ((n.__ = t), (n.i = e), Bt.__H.__h.push(n))
    }),
    (t.useRef = function (t) {
      return (
        (ue = 5),
