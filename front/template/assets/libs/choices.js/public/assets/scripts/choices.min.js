            ...
            return (
              ...
              (e.prototype._handleItemAction = function (e, t, i) {
                ...
                if (
                  ...
                  var o = t.dataset.id
                  e.forEach(function (e) {
                    e.id !== parseInt(''.concat(o), 10) || e.highlighted
              ...
              (e.prototype._searchChoices = function (e) {
                ...
                return (
                  ...
                  (this._highlightPosition = 0),
                  (this._isSearching = !0),
                  this._store.dispatch((0, a.filterChoices)(h)),
                  h.length
                )
              }),
                    ...
                    if (o instanceof HTMLElement) {
                      ...
                      'button' in a
                        ...
                        : 'item' in a
                          ...
                          : 'choice' in a && this._handleChoiceAction(s, o)
                    }
                    e.preventDefault()
                  }
                }
              ...
              (e.prototype._createTemplates = function () {
                ...
                e && 'function' == typeof e && (t = e.call(this, f.strToEl)),
                  (this._templates = (0, r.default)(_.default, t))
              }),
            ...
            return (
              ...
              (e.prototype._animateScroll = function (e, t) {
                var i = this,
                  ...
                  s = !1
                t > 0
                  ? (this._scrollDown(r, o, e), r < e && (s = !0))
                  : (this._scrollUp(r, o, e), r > e && (s = !0)),
                  s &&
                    requestAnimationFrame(function () {
              ...
              case 'ADD_ITEM':
                ...
                return s.choiceId > -1
                  ? e.map(function (e) {
                      var t = e
                      return (
                        t.id === parseInt(''.concat(s.choiceId), 10) &&
                          (t.selected = !0),
                        t
                      )
                    })
      ...
      686: function (e, t) {
        ...
        var i = {
          ...
          choice: function (e, t, i) {
            ...
            return (
              ...
              f
                ...
                : (_.classList.add(r), (_.dataset.choiceSelectable = '')),
              _
            )
          },
          input: function (e, t) {
          ...
          notice: function (e, t, i) {
            ...
            var a = [n, o]
            return (
              'no-choices' === i ? a.push(s) : 'no-results' === i && a.push(r),
              Object.assign(document.createElement('div'), {
                innerHTML: t,
                className: a.join(' '),
              })
                        ...
                        if (null != r) {
                          ...
                          if ('string' == typeof r) {
                            ...
                            if (
                              ...
                              for (
                                var b = r.split(this.options.tokenSeparator),
                                  S = [],
                                  I = 0;
                                I < h.length;
                                I += 1
                        ...
                        for (var i = 0, n = t.length; i < n; i += 1) {
                          for (
                            ...
                            var l = e ? e[o[c].key].weight : 1,
                              h =
                                (1 === l ? o[c].score : o[c].score || 0.001) * l
                            1 !== l
                              ? (a = Math.min(a, h))
                              : ((o[c].nScore = h), (s *= h))
                          }
                      ...
                      value: function (e) {
                        ...
                        for (var r = 0, s = e.length; r < s; r += 1) {
                          ...
                          if (
                            ...
                            for (
                              var c = { item: a.item }, l = 0, h = o.length;
                              l < h;
                              l += 1
                            )
                              o[l](a, c)
          ...
          function (e, t, i) {
            ...
            e.exports = function (e, t, i, r) {
              ...
              if (-1 !== y) {
                ...
                if (
                  ((g = Math.min(I, g)), -1 !== (y = e.lastIndexOf(t, v + E)))
                ) {
                  var O = n(t, {
                    errors: 0,
                    currentLocation: y,
