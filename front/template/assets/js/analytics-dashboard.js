...
if (element !== null) {
  ...
  var total = new ApexCharts(
    document.querySelector('#analytics-bouncerate'),
    total,
  )
  total.render()
}
...
if (element !== null) {
  ...
  var chart3 = new ApexCharts(
    document.querySelector('#country-sessions'),
    options,
  )
  chart3.render()
}
...
if (element !== null) {
  ...
  var chart4 = new ApexCharts(
    document.querySelector('#session-users'),
    options2,
  )
  chart4.render()
}
...
if (element !== null) {
  ...
  var chart5 = new ApexCharts(
    document.querySelector('#analytics-followers'),
    options,
  )
  chart5.render()
}
...
if (element !== null) {
  ...
  var chart6 = new ApexCharts(
    document.querySelector('#analytics-views'),
    options,
  )
  chart6.render()
}
