;(function () {
  ...
  const myChart1 = new Chart(document.getElementById('chartjs-bar'), config1)
  ...
  const myChart2 = new Chart(document.getElementById('chartjs-pie'), config3)
  ...
  const myChart4 = new Chart(document.getElementById('chartjs-mixed'), config5)
  ...
  const myChart5 = new Chart(document.getElementById('chartjs-polar'), config6)
  ...
  const myChart6 = new Chart(document.getElementById('chartjs-radar'), config7)
  ...
  const myChart8 = new Chart(document.getElementById('chartjs-bubble'), config9)
})()
